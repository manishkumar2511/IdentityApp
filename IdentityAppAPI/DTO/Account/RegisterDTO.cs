...
namespace IdentityAppAPI.DTO.Account
{
    ...
    {
        [Required]
        [StringLength(15,MinimumLength =3,ErrorMessage ="First Name must be atleast {2} and maximum {1} character")]
        public string firstName { get; set; }
        [Required]
        [StringLength(15, MinimumLength = 3, ErrorMessage = "Last Name must be atleast {2} and maximum {1} character")]
